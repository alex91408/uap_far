// tables for PCM / G711 transfer

unsigned char g723Silence[96] = {
	0xf4, 0x3a, 0xbe, 0x06, 0x0a, 0x04, 0x00, 0x00, 
	0,    0,    0,    0xc0, 0x46, 0x3f, 0x94, 0x43,
	0x17, 0x0b, 0xe5, 0xd0, 0xc5, 0xaa, 0x4a, 0x55,
	0xf4, 0x3a, 0xbe, 0x06, 0x0a, 0x04, 0x00, 0x00, 
	0,    0,    0,    0xc0, 0x46, 0x3f, 0x94, 0x43,
	0x17, 0x0b, 0xe5, 0xd0, 0xc5, 0xaa, 0x4a, 0x55,
	0xf4, 0x3a, 0xbe, 0x06, 0x0a, 0x04, 0x00, 0x00, 
...
unsigned char g729Silence[60] = {
	0x78, 0x50, 0x01, 0x82, 0x00, 0xfa, 0xc2, 0x00,
	0x03, 0x56,
	0x78, 0x50, 0x01, 0x82, 0x00, 0xfa, 0xc2, 0x00,
	0x03, 0x56,
	0x78, 0x50, 0x01, 0x82, 0x00, 0xfa, 0xc2, 0x00,
...
unsigned char a2Ulaw[256] = {			// Alaw to ulaw transfer
...
unsigned char u2Alaw[256] = {			// Ulaw to alaw transfer
	0x2a, 0x2b, 0x28, 0x29, 0x2e, 0x2f, 0x2c, 0x2d, 
	0x22, 0x23, 0x20, 0x21, 0x26, 0x27, 0x24, 0x25,
...
unsigned char  pcm2UlawTable[16384] = {
...
unsigned char pcm2AlawTable[16384] = {
...
short ulaw2PcmTab4[256];
short alaw2PcmTab4[256];
short ulaw2PcmTab1[256];
short alaw2PcmTab1[256];

short ulaw2PcmTable1[256] = {
	-8031, -7775, -7519, -7263, -7007, -6751, -6495, -6239, -5983, -5727, -5471, -5215,
	-4959, -4703, -4447, -4191, -3999, -3871, -3743, -3615, -3487, -3359, -3231, -3103, 
	-2975, -2847, -2719, -2591, -2463, -2335, -2207, -2079, -1983, -1919, -1855, -1791,
	-1727, -1663, -1599, -1535, -1471, -1407, -1343, -1279, -1215, -1151, -1087, -1023,
	 -975,  -943,  -911,  -879,  -847,  -815,  -783,  -751,  -719,  -687,  -655,  -623, 
	 -591,  -559,  -527,  -495,  -471,  -455,  -439,  -423,  -407,  -391,  -375,  -359,
	 -343,  -327,  -311,  -295,	 -279,  -263,  -247,  -231,  -219,  -211,  -203,  -195,
	 -187,  -179,  -171,  -163,  -155,  -147,  -139,  -131,  -123,  -115,  -107,   -99,
	  -93,   -89,   -85,   -81,   -77,   -73,   -69,   -65,   -61,   -57,   -53,   -49,
	  -45,   -41,   -37,   -33,   -30,   -28,   -26,   -24,   -22,   -20,   -18,   -16,
	  -14,   -12,   -10,    -8,    -6,    -4,    -2,     0,  8031,  7775,  7519,  7263,
	 7007,  6751,  6495,  6239,  5983,  5727,  5471,  5215,  4959,  4703,  4447,  4191,
	 3999,  3871,  3743,  3615,  3487,  3359,  3231,  3103,  2975,  2847,  2719,  2591,
	 2463,  2335,  2207,  2079,  1983,  1919,  1855,  1791,  1727,  1663,  1599,  1535, 
	 1471,  1407,  1343,  1279,  1215,  1151,  1087,  1023,   975,   943,   911,   879,
	  ...
	  155,   147,   139,   131,   123,   115,   107,    99,    93,    89,    85,    81,
	   77,    73,    69,    65,    61,    57,    53,    49,    45,    41,    37,    33,
	   30,    28,    26,    24,    22,    20,    18,    16,    14,    12,    10,     8,
	    6,     4,     2,     0};

short alaw2PcmTable1[256] = {
	...
	-3264, -3136, -3520, -3392,   -86,   -82,   -94,   -90,   -70,   -66,   -78,   -74, 
	 -118,  -114,  -126,  -122,  -102,   -98,  -110,  -106,   -22,   -18,   -30,   -26, 
	   -6,    -2,   -14,   -10,   -54,   -50,   -62,   -58,   -38,   -34,   -46,   -42,
	 -344,  -328,  -376,  -360,  -280,  -264,  -312,  -296,  -472,  -456,  -504,  -488,
	 -408,  -392,  -440,  -424,  -172,  -164,  -188,  -180,  -140,  -132,  -156,  -148,
	 -236,  -228,  -252,  -244,  -204,  -196,  -220,  -212,  1376,  1312,  1504,  1440, 
	 ...
	 2240,  2112,  2496,  2368,  3776,  3648,  4032,  3904,  3264,  3136,  3520,  3392,
	   86,    82,    94,    90,    70,    66,    78,    74,   118,   114,   126,   122,
	  102,    98,   110,   106,    22,    18,    30,    26,     6,     2,    14,    10, 
	   54,    50,    62,    58,    38,    34,    46,    42,   344,   328,   376,   360, 
	  280,   264,   312,   296,   472,   456,   504,   488,   408,   392,   440,   424,
	  172,   164,   188,   180,   140,   132,   156,   148,   236,   228,   252,   244,
	  204,   196,   220,   212} ;

short ulaw2PcmTable4[256] = {
